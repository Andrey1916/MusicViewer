...
namespace MusicView.Styles.VS2012
{
    ...
    public partial class VS2012WindowStyle
    {
        ...
        void WindowLoaded(object sender, RoutedEventArgs e) => ((Window)sender).StateChanged += WindowStateChanged;
        ...
        void WindowStateChanged(object sender, EventArgs e)
        {
            ...
            else containerBorder.Padding = new Thickness(7, 7, 7, 5);
        }

        void CloseButtonClick(object sender, RoutedEventArgs e) => sender.ForWindowFromTemplate(w => SystemCommands.CloseWindow(w));

        void MinButtonClick(object sender, RoutedEventArgs e) => sender.ForWindowFromTemplate(w => SystemCommands.MinimizeWindow(w));
        
        void MaxButtonClick(object sender, RoutedEventArgs e) => sender.ForWindowFromTemplate(w =>
                                        {
